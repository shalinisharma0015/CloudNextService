...
function initMobileMenu(){
  ...
  if(menuBtn && menu){
    ...
    document.querySelectorAll(".m-menu .sub-menu a").forEach(link => {
...
// ================= SLIDER 3 =================
function isCardSliderView(){
  return window.matchMedia("(max-width: 767.98px), (max-width: 991.98px) and (max-height: 720px)").matches;
}
(function(){
